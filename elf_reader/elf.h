...
{
    return (SYMBOL_TABLE_BINDING_T)(table.st_info >> 4);
}

static inline SYMBOL_TABLE_TYPE_T Elf_Reader_symbolTableSymbolType(const Elf32_Sym table)
{
    return (SYMBOL_TABLE_TYPE_T)(table.st_info & 0xff);
}
...
ELF_T Elf_Reader_loadElf(const char* fileName);
